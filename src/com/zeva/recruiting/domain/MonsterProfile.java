...
public class MonsterProfile {
    ...
    public MonsterProfile(){};//default constructor
    
    public MonsterProfile(String monsterUsername,String monsterPassword, int max,int candidateIndex, String afterDate, String searchAgent,
